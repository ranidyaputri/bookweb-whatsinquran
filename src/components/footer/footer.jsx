            ...
            <div className="footer-text w-full flex flex-col sm:flex-row justify-between sm:items-center">
                ...
                <div className="contact-list text-sm md:text-base">
                    ...
                    <div className="flex items-center mb-[12px]">
                        ...
                        <a href="https://wa.me/60178361381" target="_blank" className="ml-[13px]">+60 178361381</a>
                    </div>
                    <div className="flex items-center">
                        ...
                        <a href="mailto:whatsinquran.edu@gmail.com" target="_blank" className="ml-[13px]">whatsinquran.edu@gmail.com</a>
                    </div>
                </div>
            </div>
        </div>
